...
@Component({
  ...
  styles: [
    ...
    `.content p{margin:.2rem 0 0}`,`.success{border-left:5px solid #2e7d32}`,.error{border-left:5px solid #c62828}`,.warning{border-left:5px solid #ef6c00}`,.info{border-left:5px solid #1565c0}`
  ]
})
